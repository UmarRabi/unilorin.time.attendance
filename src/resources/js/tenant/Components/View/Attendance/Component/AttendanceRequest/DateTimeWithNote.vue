...
<div>
    <div class="d-flex align-items-center">
        ...
        <app-note-editor v-if="Object.keys(comment).length" :id="comment.id" :row-data="comment" :note-title="$t(comment.type)" :note-description="comment.comment" :url="`${apiUrl.ATTENDANCE_NOTES}/${comment.id}`" :edit-permission="permission" />
    </div>
